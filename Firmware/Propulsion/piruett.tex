...
\M{17}
Calling \PB{\\{edgeSelect}(\,)} will get it ready for the first rising edge of
channel~2.
Each call to \PB{\\{edgeSelect}} rotates to the next edge type.
...
\Y\B\&{if} ${}(\\{translation\_s}.\\{portOut}\V\\{translation\_s}.%
\\{starboardOut}){}$\1\5
\\{ledCntl}(\.{OFF});\2\6
\&{else}\1\5
\\{ledCntl}(\.{ON});\2\7
...
Escentialy is grabs and processes the \PB{\\{Input}\\{Capture}} data.
...
\M{24}
This is a variant of \PB{\\{pwcCalc}} that flips the \PB{\\{lostSignal}} flag.
\Y\B\.{ISR}(\\{WDT\_vect})\7
${}\{{}$\1\7
...
\Y\B\&{void} \\{portDirection}(\\{int8\_t}\\{state})\7
${}\{{}$\1\7
...
$\{{}$\7
$\\{int16\_t}\\{speed}\K\\{trans\_s}\MG\\{thrust}{}$;\SHC{ assuming it's close
}\6
\\{int16\_t}\\{rotation};\6
...
${}\\{trans\_s}\MG\\{portOut}\K{-}\\{max};{}$\2\6
\&{else} \&{if} ${}(\\{trans\_s}\MG\\{thrust}\E\T{0}){}$\1\5
${}\\{trans\_s}\MG\\{portOut}\K\\{piruett};{}$\2\6
\&{else}\1\5
...
\Y\B\&{if} ${}(\\{trans\_s}\MG\\{portOut}\V\\{trans\_s}\MG\\{starboardOut}){}$%
\1\5
