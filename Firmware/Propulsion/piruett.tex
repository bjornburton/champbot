...
\Y\B\X27:Configure to idle on sleep\X\\{ledcntl}(\.{OFF});\6
...
\4${}\}{}$\SHC{ end if handleirq }\SHC{24200=ch1, center }\SHC{32000=ch1, hard
left with full trim }\SHC{16200=ch1, hard right with full trim }\2\6
\&{if} ${}(\\{input\_s}.\\{ch1duration}>\T{32200}){}$\1\5
\\{ledcntl}(\.{ON});\2\6
\&{else}\1\5
\\{ledcntl}(\.{OFF});\2\7
$\}{}$\SHC{ end for }\7
