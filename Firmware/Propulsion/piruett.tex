...
\\{int16\_t}\\{portOut};\SHC{ -255 to 255 }\2\6
${}\}{}$ \&{transStruct};\par
\fi

\M{9}Here is a structure type to contain the scaling parameters for the scaler.
\Y\B\4\X7:Types\X${}\mathrel+\E{}$\6
\&{typedef} \&{struct} ${}\{{}$\1\6
\\{int16\_t}\\{minIn};\SHC{ input, minimum }\6
\\{int16\_t}\\{maxIn};\SHC{ input, maximum }\6
...
\Y\B\4\X11:Global variables\X${}\E{}$\6
...
\X35:Initialize the inputs and capture mode\X\X32:Initialize pin outputs\X\Y\par
\fi
...
OC0B (D6), respectivly.
\Y\B\X37:Initialize the Timer Counter 0 for PWM\X\par
\fi
...
\Y\B\X33:Configure to idle on sleep\X\7
\\{ledcntl}(\.{OFF});\6
...
${}\\{translation\_s}.\\{track}\K\T{100}{}$;\SHC{ represent unitless prop-prop
distance }\6
...
\N{1}{29}Supporting routines, functions, procedures and configuration
blocks.
\fi
...
\M{32}\B\X32:Initialize pin outputs\X${}\E{}$\6
${}\{{}$\C{ set the led port direction; This is pin \#17 }\1\6
${}\.{DDRB}\MRL{{\OR}{\K}}(\T{1}\LL\.{DDB5}){}$;\SHC{ 14.4.9 DDRD – The Port
...
Data direction to output (sec 14.3.3) }\6
\4${}\}{}$\2\par
\U14.\fi

\M{33}\B\X33:Configure to idle on sleep\X${}\E{}$\6
${}\{{}$\1\6
...
\M{35}\B\X35:Initialize the inputs and capture mode\X${}\E{}$\6
...
\M{37}\B\X37:Initialize the Timer Counter 0 for PWM\X${}\E{}$\6
...
\T{100};{}$\6
\&{const} \\{int16\_t}\\{ampFact}${}\K\T{128}{}$;\SHC{ factor for precision }\7
${}\\{speed}\K\\{trans\_s}\MG\\{thrust}{}$;\SHC{ cheating a bit here }\par
\fi
...
\4${}\}{}$\2\6
\&{if} ${}(\\{trans\_s}\MG\\{starboardOut}>\T{0}){}$\5
${}\{{}$\1\6
