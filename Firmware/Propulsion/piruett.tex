...
\X35:Initialize the inputs and capture mode\X\X32:Initialize pin outputs\X%
\\{cli}(\,);\SHC{ disable interrupts }\6
\X37:Initialize watchdog timer\X\Y\par
\fi
...
OC0B (D6), respectivly.
\Y\B\X39:Initialize the Timer Counter 0 for PWM\X\par
\fi
...
\Y\B\&{if} ${}(\\{translation\_s}.\\{portOut}\Z\T{200}){}$\1\5
\\{ledcntl}(\.{ON});\2\6
\&{else}\1\5
\\{ledcntl}(\.{OFF});\2\7
$\}{}$\SHC{ end for }\7
...
${}\{{}$\1\7
${}\\{input\_s}\MG\\{ch2duration}\K\T{0};{}$\6
${}\\{input\_s}\MG\\{ch1duration}\K\T{0};{}$\6
${}\\{input\_s}\MG\\{ch2rise}\K\T{0};{}$\6
${}\\{input\_s}\MG\\{ch2fall}\K\T{0};{}$\6
${}\\{input\_s}\MG\\{ch1fall}\K\T{0};{}$\6
${}\\{input\_s}\MG\\{edge}\K\.{CH2RISE}{}$;\SHC{ first step }\6
...
\M{37}\B\X37:Initialize watchdog timer\X${}\E{}$\6
${}\{{}$\1\6
...
\M{39}\B\X39:Initialize the Timer Counter 0 for PWM\X${}\E{}$\6
...
\Y\B\&{if} ${}(\\{input}>\\{input\_s}\MG\\{maxIn}){}$\1\5
\&{return} \\{trans\_s}${}\MG\\{maxOut};{}$\2\6
\&{else} \&{if} ${}(\\{input}<\\{input\_s}\MG\\{minIn}){}$\1\5
\&{return} \\{trans\_s}${}\MG\\{minOut};{}$\2\6
\&{else} \&{if} ${}(\\{input}\E\T{0}{}$)\SHC{ no valid signal }\1\6
\&{return} \T{0};\2\par
\fi
