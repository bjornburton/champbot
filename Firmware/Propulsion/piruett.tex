...
\Y\B\\{cli}(\,);\7
\X47:Initialize the inputs and capture mode\X\X44:Initialize pin outputs\X%
\X49:Initialize watchdog timer\X\Y\par
\fi
...
OC0B (D6), respectivly.
\Y\B\X51:Initialize the Timer Counter 0 for PWM\X\par
\fi
...
\Y\B\X45:Configure to idle on sleep\X\7
\\{ledCntl}(\.{OFF});\par
\fi
...
\M{44}\B\X44:Initialize pin outputs\X${}\E{}$\SHC{ set the led port direction;
This is pin \#17 }\6
...
\M{45}\B\X45:Configure to idle on sleep\X${}\E{}$\6
${}\{{}$\1\6
...
\M{47}\B\X47:Initialize the inputs and capture mode\X${}\E{}$\6
...
\M{49}\B\X49:Initialize watchdog timer\X${}\E{}$\6
${}\{{}$\1\6
...
\M{51}\B\X51:Initialize the Timer Counter 0 for PWM\X${}\E{}$\6
