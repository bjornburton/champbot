...
\X33:Initialize the inputs and capture mode\X\X30:Initialize pin outputs\X\Y\par
\fi
...
OC0B (D6), respectivly.
\Y\B\X35:Initialize the Timer Counter 0 for PWM\X\par
\fi
...
\Y\B\X31:Configure to idle on sleep\X\7
\\{ledcntl}(\.{OFF});\6
...
\M{33}\B\X33:Initialize the inputs and capture mode\X${}\E{}$\6
...
\M{35}\B\X35:Initialize the Timer Counter 0 for PWM\X${}\E{}$\6
