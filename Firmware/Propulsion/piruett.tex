...
${}\.{TCCR0A}\MRL{\AND{\K}}\CM(\T{1}\LL\.{COM0A0}){}$;\SHC{ Clear on Comparator
...
${}\.{TCCR0A}\MRL{\AND{\K}}\CM(\T{1}\LL\.{COM0B0}){}$;\SHC{ Clear on Comparator
B match (table 15-7) }\6
\4${}\}{}$\2\7
\4${}\}{}$\2\Y\par
\fi
...
match (table 15-4) }\SHC{ 15.9.2 TCCR0B – Timer/Counter Control Register B }\6
